  ...
  return (
    <form onSubmit={handleSubmit} key={category?.id} className="">
      <fieldset className="grid grid-cols-3 gap-2" disabled={!editing}>
        {!editing ?
          <>
            <Link to={`/category/${category?.id}/clothes`} className="p-2">{category?.id}</Link>
            <Link to={`/category/${category?.id}/clothes`} className="p-2">{category?.name}</Link>
            <Link to={`/category/${category?.id}/clothes`} className="p-2">{category?.description}</Link>
          </>
          :
          <>
