...
class ClotheService(metaclass=SingletonMeta):
    ...
    # def get_clothes(self, id_category=None, id_gender=None, page=1, page_size=10, sort_by='id', sort_order=None, name=None):
    #     clothes = self.clothe_repository.get_clothes(id_category, id_gender, page, page_size, sort_by, sort_order, name)
    #     if clothes is None:
    #         return [None, 'Clothes not found', 404]
    #     return [clothes, 'Clothes retrieved successfully', 200]
